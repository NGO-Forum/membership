...
@section('content')
    <div class="pt-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('events.calendar', ['month' => now()->month, 'year' => now()->year]) }}"
                    class="px-4 py-1 rounded bg-blue-600 text-white">Today</a>
        ...
        <div class="overflow-x-auto">
            <div class="grid grid-cols-7 min-w-[700px] bg-green-600 text-white font-semibold rounded-t-lg">
            ...
            @while ($weekStart <= $gridEnd)
                {{-- WEEK ROW --}}
                <div class="relative grid grid-cols-7 min-w-[700px] h-24 md:h-36 border-b border-green-300">
                    ...
                    @foreach ($events as $event)
                        @php
                            ...
                            $isActiveToday = $today->between(
                                $renderStart->copy()->startOfDay(),
                                $renderEnd->copy()->endOfDay(),
                            );
                        @endphp
