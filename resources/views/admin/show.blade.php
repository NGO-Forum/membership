                                        ...
                                        <div class="space-y-6">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div class="space-y-4">
                                                    <div class="flex items-start gap-3">
                                                        ...
                                                        <div>
                                                            <h4 class="font-semibold text-gray-900 mb-1">Mailing Address
                                                            </h4>
                                                            <p class="text-gray-700">{{ $app->mailing_address ?? 'N/A' }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="space-y-4">
                                                    <div>
                                                        <h4 class="font-semibold text-gray-900 mb-2">Communication Channels
                                                        </h4>
                                            ...
                                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                                <div class="vision-card p-4 rounded-lg">
                                                    ...
                                                    <p class="text-white leading-relaxed">{{ $app->vision ?? 'N/A' }}</p>
                                                </div>
                                                ...
                                                <div class="mission-card p-4 rounded-lg">
                                                    ...
                                                    <p class="text-white leading-relaxed">{{ $app->mission ?? 'N/A' }}</p>
                                                </div>
                                                ...
                                                <div class="goal-card p-4 rounded-lg">
                                                    ...
                                                    <p class="text-white leading-relaxed">{{ $app->goal ?? 'N/A' }}</p>
                                                </div>
                                            </div>
