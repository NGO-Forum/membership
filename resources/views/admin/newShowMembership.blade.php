                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            @php
                                $statusColor = match ($membership->status) {
                                    ...
                                    'cancel', 'rejected' => 'bg-red-500',
                                    default => 'bg-gray-400',
                                };
                            @endphp

                            <span class="px-2 py-1 text-white text-sm rounded {{ $statusColor }}">
                            ...
                            @if (auth()->user()->role === 'admin' && !$membership->assessmentReport)
                                <form method="POST" action="{{ route('reports.generate', $membership->id) }}">
                                    ...
                                    <button type="submit"
                                        class="flex items-center gap-1 px-3 py-1 text-sm font-medium text-white bg-yellow-500 rounded hover:bg-yellow-600 transition">
                                        Generate
                                    </button>
                                </form>
                            @endif
                            ...
                            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">List of focal points and their network details</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 mb-4">
                                            ...
                                            <h4 class="font-semibold text-lg text-green-900">Target Program Areas</h4>
                                        </div>
