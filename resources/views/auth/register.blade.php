...
<body class="bg-green-600 flex items-center justify-center min-h-screen px-4">
    <div class="bg-white p-8 mt-4 mb-4 rounded-2xl shadow-2xl max-w-3xl w-full">
        <div class="flex flex-col items-center mb-8">
            ...
            <h2 class="text-xl font-extrabold mb-8 text-center text-green-800">
                Please Create an Account to Register as membership
            </h2>
        </div>
        @if ($errors->any())
        ...
        <form action="{{ route('register') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @csrf
            <div>
                <label for="ngo" class="block text-gray-700 font-semibold mb-2">Your Organization Name</label>
                <input type="text" name="ngo" id="ngo" required value="{{ old('ngo') }}"
            ...
            <div class="md:col-span-2">
                <label for="email" class="block text-gray-700 font-semibold mb-2">Email of your Organization</label>
